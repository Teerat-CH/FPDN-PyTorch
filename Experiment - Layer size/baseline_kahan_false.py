...
model = nn.Sequential(
    AccuLinearLayer(input_size, middle_hidden_size, False),
    nn.ReLU(),
    AccuLinearLayer(middle_hidden_size, output_size, False)
)
...
results_filename = os.path.join(script_dir, "results/baseline_kahan_false_2048.json")
