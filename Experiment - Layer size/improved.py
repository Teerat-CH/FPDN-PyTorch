...
model = nn.Sequential(
    AccuLinearLayer(input_size, middle_hidden_size, True),
    nn.ReLU(),
    AccuLinearLayer(middle_hidden_size, output_size, True)
)
...
results_filename = os.path.join(script_dir, "results/improved_kahan_true_1024.json")
